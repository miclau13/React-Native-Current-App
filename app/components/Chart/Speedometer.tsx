...
// Utils
import calculateDegreeFromLabels from './utils/calculateDegreeFromLabels';
import calculateLabelFromValue from './utils/calculateLabelFromValue';
...
class Speedometer extends Component {
  ...
  render() {
    const {
      ...
      labelStyle,
      labelNoteStyle,
      calculateLabelFromValue: customCalculateLabelFromValue,
      limitValue: customLimitValue,
    } = this.props;
    const degree = 180;
    const perLevelDegree = calculateDegreeFromLabels(degree, labels);
    const label = customCalculateLabelFromValue ? customCalculateLabelFromValue(
